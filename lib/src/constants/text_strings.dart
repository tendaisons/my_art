...
const String tForgetPasswordEmail = "Please enter your email address to get started";
...
const String tFABBottomSheetSubTitle = "Select one of the options given below to submit a picture for Assessment.";
