...
class TTextTheme {
  static TextTheme lightTextTheme = TextTheme(
    ...
    titleSmall: GoogleFonts.montserrat(fontSize: 14.0, fontWeight: FontWeight.w600, color: Colors.white),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    titleLarge: GoogleFonts.poppins(fontSize: 12.0, fontWeight: FontWeight.w600, color: tWhiteColor),
    titleSmall: GoogleFonts.montserrat(fontSize: 14.0, fontWeight: FontWeight.w600, color: Colors.white),
